  ...
  return (
    <Layout>
      <div className="bg-gray-300 flex justify-center ">
        <div className="flex flex-col p-20 pt-32 w-full md:w-2/5 justify-center text-center">
          <h1 className="flex text-5xl font-bold  justify-center text-center text-white">
            Remindy
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
            <div className="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
              <div className="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                ...
                <div className="w-full text-center text-xl mt-10 mb-0">
                  100 Messages
                </div>
              </div>
            ...
            <div className="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-gray-100 mt-4">
              <div className="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                <div className="p-8 text-3xl font-bold text-center border-b-4">
                  Pro
                </div>
